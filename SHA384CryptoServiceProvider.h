#ifndef SHA512_SHA384CRYPTOSERVICEPROVIDER_H
#define SHA512_SHA384CRYPTOSERVICEPROVIDER_H
...
public:
    ...
    std::string Hashing(char* message);
};

#endif //SHA512_SHA384CRYPTOSERVICEPROVIDER_H
